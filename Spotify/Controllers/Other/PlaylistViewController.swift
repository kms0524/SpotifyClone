...
class PlaylistViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        APICaller.shared.getPlaylistDetails(for: playlist) { [weak self] result in DispatchQueue.main.async {
            switch result {
    ...
    @objc func didLongPress(_ gesture: UILongPressGestureRecognizer) {
        ...
        let actionSheet = UIAlertController(
            ...
            message: "이 노래를 플레이리스트에서 삭제하시겠습니까?",
...
extension PlaylistViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionKView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
