...
class HomeViewController: UIViewController {
    ...
    @objc func didLongPress(_ gesture: UILongPressGestureRecognizer) {
        ...
        let actionSheet = UIAlertController(
            title: model.name,
            message: "이 노래를 플레이리스트에 추가하시겠습니까?",
            preferredStyle: .actionSheet)
        
        actionSheet.addAction(UIAlertAction(title: "취소", style: .cancel, handler: nil))
        actionSheet.addAction(UIAlertAction(title: "추가", style: .default, handler: { [weak self] _ in
    ...
    private func fetchData() {
        ...
        var recommmendations: RecommendationsResponse?
        ...
        APICaller.shared.getRecommendedGenres { result in
            ...
            case .success(let model):
                ...
                APICaller.shared.getRecommendations(genres: seeds) { recommendResult in
        ...
        group.notify(queue: .main) {
            guard let newAlbums = newReleases?.albums.items,
                  ...
                  let tracks = recommmendations?.tracks else {
                fatalError("models nil")
            }
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        case 0:
            ...
            section.boundarySupplementaryItems = supplementartyViews
            return section
        case 1:
            // 아이템
